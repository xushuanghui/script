...
GIT_REPO_GROUPS = {'AssemblyComponent': '2dfire-ios', 'ActivityForRestApp': '2dfire-ios'}
CHECK_PODS = ['TDFCelebiActions','TDFCelebiLogisticsModule','TDFPresentationController']
